"""Модуль для работы со случайными значениями."""
...
class Apple(GameObject):
    ...
    def draw(self, surface):
        """Рисует объект и его границу на указанной поверхности."""
        rect = pygame.Rect(
...
class Snake(GameObject):
    """Объект змейки с направлением и телом."""
    ...
    def draw(self, surface):
        """Рисует тело змейки на указанной поверхности."""
    ...
    def update_direction(self):
        """Обновляет направление движения змейки, если указано новое."""
        if self.next_direction:
            self.direction = self.next_direction
            self.next_direction = None
...
def main():
    """Основной цикл игры: обработка событий, логика и отрисовка."""
